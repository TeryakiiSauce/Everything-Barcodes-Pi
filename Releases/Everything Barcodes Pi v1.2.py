...
##  Birthday       : December 12, 2019 - 6:30 PM     ##
##  Date Started   : December 24, 2019 - 2:13 AM     ##
##  Date Updated   : December 25, 2019 - 1:15 AM     ##
##                                                   ##
##                 *****************                 ##
##                                                   ##
    ...
    try :
        ...
        while valid == False :
            ...
            if barcodeInput.isdigit() == True or "-" in barcodeInput :
                ...
                print("Error 101 occured : Barcodes must only contain numerical digits and - (dashes); otherwise command entered is invalid!\nPlease try again...\n");
